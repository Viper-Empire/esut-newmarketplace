...
describe("persistent vertical category migration contract", () => {
  it("presents the migrated Food and Accommodation rows without mutating other fields", () => {
    ...
    expect(accommodation).toEqual({ id: 5, name: "Accommodation", slug: "accommodation", sortOrder: 4, availability: "COMING_SOON" });
    expect(food).toEqual({ id: 6, name: "Food", slug: "food", sortOrder: 5, availability: "COMING_SOON" });
  });
