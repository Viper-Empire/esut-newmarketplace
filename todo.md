...
- [x] Add a lightweight browser-level smoke suite using the available Chromium runtime for public discovery, protected account boundaries, responsive rendering, and basic accessibility assertions. (Seven Playwright scenarios now pass through `pnpm test:e2e`, including branded login/registration reachability and seller/moderator/administrator access boundaries; the script is available for local and CI execution.)
