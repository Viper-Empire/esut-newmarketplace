...
- [x] Add a lightweight browser-level smoke suite using the available Chromium runtime for public discovery, protected account boundaries, responsive rendering, and basic accessibility assertions. (Five Playwright scenarios pass through `pnpm test:e2e`; the script is available for local and CI execution.)
