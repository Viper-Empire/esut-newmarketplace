...
- [ ] Submit genuine seller evidence from the currently available unverified seller session and confirm it appears as pending in the administrator verification queue, without deciding the record.
