...
- [ ] Reproduce the original non-JSON response condition across representative public and authenticated marketplace flows, document each safe path, and add automated guarded-transport regressions for those scenarios.
