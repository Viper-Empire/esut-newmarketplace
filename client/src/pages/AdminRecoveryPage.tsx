...
export default function AdminRecoveryPage() {
  ...
  return <main className="page-shell py-8"><p className="eyebrow text-[#e31b23]">ADMINISTRATION</p><div className="mt-2 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between"><div><h1 className="text-3xl font-extrabold">Action recovery</h1><p className="mt-2 max-w-2xl text-slate-600">Recover eligible accidental moderation changes while preserving the complete audit history.</p></div><Link href="/admin" className="text-sm font-extrabold text-[#006b32]">← Back to overview</Link></div><AdminReversibleActionsPanel /></main>;
}
