  ...
  return <>
    ...
    <header className="market-header">
      <div className="page-shell flex h-[76px] items-center gap-4">
        ...
        <nav className="ml-auto hidden items-center gap-4 lg:flex"><ThemePreferenceSelect compact />
