...
export function StorefrontHeader({ categories }: { categories: { id: number; name: string; slug: string; availability?: "ACTIVE" | "COMING_SOON" }[] }) {
  ...
  const isControlPlane = user?.role === "ADMIN" || user?.role === "SUPER_ADMIN";
