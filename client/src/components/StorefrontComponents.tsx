  ...
  return <>
    ...
    <header className="market-header">
      <div className="page-shell flex h-[76px] items-center gap-4">
        <Link href="/" className="flex shrink-0 items-center"><MarketplaceLogo className="h-14 w-14"/><span className="hidden text-base font-black leading-4 text-[#111827] sm:block">ESUT<br/><em className="not-italic text-[#00843d]">Marketplace</em></span></Link>
